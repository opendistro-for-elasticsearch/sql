...
public class DSL {
  ...
  public FunctionExpression floor(Expression... expressions) {
    return (FunctionExpression)
        repository.compile(BuiltinFunctionName.FLOOR.getName(), Arrays.asList(expressions));
  }

  public FunctionExpression ln(Expression... expressions) {
    return (FunctionExpression)
        repository.compile(BuiltinFunctionName.LN.getName(), Arrays.asList(expressions));
  }
