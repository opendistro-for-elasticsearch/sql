...
public class Queries {
  ...
  static {
    /*
    queries.add("select l_returnflag, l_linestatus, sum(l_quantity) as sum_qty, sum(l_extendedprice)"
        ...
        + "as avg_qty, avg(l_extendedprice) as avg_price, avg(l_discount) as avg_disc, count(*) as "
        + "count_order from lineitem group by l_returnflag, l_linestatus order by l_returnflag, "
        + "l_linestatus");
    */
  }
}
