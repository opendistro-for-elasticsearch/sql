...
import static com.amazon.opendistroforelasticsearch.sql.legacy.util.CheckScriptContents.scriptHasPattern;
...
public class DateFunctionsTest {
    ...
    public void date() {
        ...
        assertTrue(
                scriptContainsString(
                        scriptField,
                        "LocalDate.parse(doc['creationDate'].value.toString(), "
