...
import com.amazon.opendistro.sql.query.DefaultQueryAction;
import com.amazon.opendistro.sql.query.maker.QueryMaker;
import com.amazon.opendistro.sql.util.HasFieldWithValue;
    ...
    private SearchRequest translate(SQLQueryExpr expr) {
        try {
            ...
            if (select.getWhere() != null) {
                request.setQuery(QueryMaker.explan(select.getWhere(), select.isQuery));
            }
