...
/**
 * The path of the aggregation which using ">" as separator when build bucket path.
 * https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline.html#buckets-path-syntax
 */
public class AggPath implements Path {
    private final String name;
    private static String AGG_SEPARATOR = ">";

    public AggPath(String name) {
        this.name = name;
    }
