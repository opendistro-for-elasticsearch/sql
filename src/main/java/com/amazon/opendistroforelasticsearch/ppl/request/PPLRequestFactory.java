...
public class PPLRequestFactory {
    ...
    private static PPLRequest parsePPLRequestFromUrl(RestRequest restRequest) {
        String ppl;
        ...
        return new PPLRequest(ppl, null);
    }

    private static PPLRequest parsePPLRequestFromPayload(RestRequest restRequest) {
        ...
        return new PPLRequest(jsonContent.getString(PPL_FIELD_NAME), jsonContent);
    }
}
