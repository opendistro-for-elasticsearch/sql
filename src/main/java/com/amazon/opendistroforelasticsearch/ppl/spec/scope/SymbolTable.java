...
public class SymbolTable<T> {
    ...
    private Map<Namespace, NavigableMap<String, T>> tableByNamespace = new EnumMap<>(Namespace.class);
     ...
     */
    public void store(Symbol symbol, T type) {
    ...
    public Optional<T> lookup(Symbol symbol) {
        Map<String, T> table = tableByNamespace.get(symbol.getNamespace());
        T type = null;
        if (table != null) {
     ...
     */
    public Map<String, T> lookupByPrefix(Symbol prefix) {
        NavigableMap<String, T> table = tableByNamespace.get(prefix.getNamespace());
        if (table != null) {
     ...
     */
    public Map<String, T> lookupAll(Namespace namespace) {
