...
public class Context<T> {
    ...
    private Environment<T> environment = new Environment<T>(null);

    /**
     * Push a new environment
     */
    public void push() {
        environment = new Environment<T>(environment);
    }
    ...
    public Environment<T> pop() {
        ...
        Environment<T> curEnv = environment;
